...
class AppTheme {
  ...
  static final lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
      ...
      surface: lightBackgroundColor, // Optional, if needed for surfaces.
    ),
    scaffoldBackgroundColor: lightBackgroundColor, // For scaffold background.
    textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(
        foregroundColor: lightPrimaryColor, // Correct parameter for text color.
      ),
    ),
  );
